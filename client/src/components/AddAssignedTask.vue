<template>
  <!-- Modal -->
  <div class="modal fade" id="addAssignedTaskModal" tabindex="-1"
    role="dialog" aria-labelledby="addAssignedTaskModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Add New Assigned Task</h5>
          <button type="button" class="close"
            id="addAssignedTaskClose" data-dismiss="modal" aria-label="Close">
